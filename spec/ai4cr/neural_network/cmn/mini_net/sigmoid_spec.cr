...
#       assert_equality_of_nested_list deltas_before, [[0.0,0.0]]
#       # assert_inequality_of_nested_list deltas_before, deltas_after
#       # assert_approximate_inequality_of_nested_list deltas_before, deltas_after, 0.0000001
#     end
...
#       weights_after.should eq(expected_new_weights)
#     end
...
#   net.train(inputs, outputs)
#   weights_after = net.weights.clone
#   assert_approximate_equality_of_nested_list weights_before, hard_coded_weights, 0.0000001
#   assert_approximate_inequality_of_nested_list weights_after, weights_before, 0.0000001
# end
#   it "weights do change" do
#     net.init_network
#     net.learning_rate = 0.25
...
#     # weights_after.should eq(expected_new_weights)
#     # assert_approximate_equality_of_nested_list weights_after, expected_new_weights, 0.0000001
#   end
