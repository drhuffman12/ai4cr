  ...
  describe "#initialize" do
    context "when NOT passing in any values" do
      ...
      context "has expected value for property" do
        it "time_col_qty" do
          rnn_simple.time_col_qty.should eq(2)
        end

        it "hidden_layer_qty" do
          rnn_simple.hidden_layer_qty.should eq(1)
        end

        it "input_size" do
          rnn_simple.input_size.should eq(2)
        end

        it "output_size" do
          rnn_simple.output_size.should eq(1)
        end

        it "hidden_size" do
          rnn_simple.hidden_size.should eq(3)
        end
      end
    end
...
rnn_simple = Ai4cr::NeuralNetwork::Cmn::RnnSimple.new
puts rnn_simple.valid
puts rnn_simple.errors
puts rnn_simple.to_json
