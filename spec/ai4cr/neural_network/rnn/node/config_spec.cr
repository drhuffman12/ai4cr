...
describe Ai4cr::NeuralNetwork::Rnn::Node::Config do
  describe "#initialize" do
    describe "when given no params" do
      ...
      rnn_node_config = Ai4cr::NeuralNetwork::Rnn::Node::Config.new(
        rnn_config,
      ...
      it "exports to json as expected" do
        contents = File.read("spec/data/neural_network/rnn/node/config/new.defaults.json")
