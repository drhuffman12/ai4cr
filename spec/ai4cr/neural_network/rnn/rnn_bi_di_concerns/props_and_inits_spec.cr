...
Spectator.describe Ai4cr::NeuralNetwork::Rnn::RnnBiDiConcerns::PropsAndInits do
  describe "#initialize" do
    context "when NOT passing in any values" do
      let(rnn_simple) { Ai4cr::NeuralNetwork::Rnn::RnnBiDi.new }
      ...
      context "has expected value for property" do
        ...
        #         "previous_time_column":    0,
        #         "next_time_column":    3, # 2 input values + 1 bias value
        #       },
        #       {
        #         "previous_synaptic_layer": rnn_simple.input_size,
        ...
        #         "previous_time_column":    0,
        #         "next_time_column":    rnn_simple.output_size,
        #       },
        #       {
        #         "previous_synaptic_layer": rnn_simple.hidden_size,
    ...
    context "when passing in hidden_size_given of 10" do
      ...
      let(rnn_simple) { Ai4cr::NeuralNetwork::Rnn::RnnBiDi.new(hidden_size_given: hidden_size_given) }
    ...
    context "when passing in hidden_layer_qty of 2, hidden_size_given of 10" do
      ...
      let(hidden_size_given) { 10 }
      let(rnn_simple) { Ai4cr::NeuralNetwork::Rnn::RnnBiDi.new(hidden_layer_qty: hidden_layer_qty, hidden_size_given: hidden_size_given) }
    ...
    context "when passing in time_col_qty of 3, hidden_layer_qty of 2, hidden_size_given of 10" do
      ...
      let(hidden_layer_qty) { 2 }
      let(hidden_size_given) { 10 }
      let(rnn_simple) { Ai4cr::NeuralNetwork::Rnn::RnnBiDi.new(time_col_qty: time_col_qty, hidden_layer_qty: hidden_layer_qty, hidden_size_given: hidden_size_given) }
