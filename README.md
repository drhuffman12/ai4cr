...
e.g.: `time CRYSTAL_WORKERS=14 crystal spec examples/rnn_simple_manager_example.cr --release -D preview_mt`
e.g.: `time CRYSTAL_WORKERS=24 crystal spec examples/rnn_simple_manager_example.cr --release -D preview_mt > tmp/log.txt 2>&1`
