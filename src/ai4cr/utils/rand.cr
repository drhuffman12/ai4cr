  ...
  module Utils
    class Rand
      ...
      def self.rand_neg_one_to_pos_one_no_zero
        Ai4cr::Utils::Rand.rand_excluding(scale: 2, offset: -1.0, excludes: [0.0])
      end

      # Ai4cr::Utils::Rand.rand_neg_half_to_pos_one_and_half_no_zero_no_one
      # -0.5..1.5 but no 0.0 and no 1.0
      def self.rand_neg_half_to_pos_one_and_half_no_zero_no_one
        Ai4cr::Utils::Rand.rand_excluding(scale: 2, offset: -0.5)
      end
    end
  end
end
