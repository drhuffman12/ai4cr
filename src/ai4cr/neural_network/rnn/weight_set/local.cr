      ...
      module WeightSet
        ...
        class Local(CINS, PLOC)
          ...
          def initialize(
            ...
            init_center(time_column_index, previous_layer_output_channel, output_node_set)
            init_side_past(time_column_index, dendrite_offsets, previous_layer_output_channel, output_node_set)
            init_side_future(time_column_index, dendrite_offsets, previous_layer_output_channel, output_node_set)
