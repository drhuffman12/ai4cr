    ...
    module Rnn
      module HiddenLayer
        class Common(CINS, SINS, PLOC, ONS) # Ai4cr::NeuralNetwork::Rnn::HiddenLayer::Common
          ...
          def initialize(@previous_layer_output_channel : PLOC, @bias, @output_winner_qty, @layer_index, @time_column_qty = TIME_COLUMN_QTY_DEFAULT, @dendrite_offsets = Channel::Interface::DENDRITE_OFFSETS_DEFAULT, @state_qty = NodeSet::Interface::STATE_QTY_DEFAULT)
