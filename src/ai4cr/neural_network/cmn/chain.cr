  ...
  module NeuralNetwork
    module Cmn
      class Chain
        ...
        # # TODO: init via calc @net_set params based on @structure and learning_styles(s)
        # def initialize(@structure, @learning_styles : LearningStyle, @learning_styles : Array(LearningStyle))
        # end
