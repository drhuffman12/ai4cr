...
def graph(ios_list, charter_high_is_red, charter_high_is_blue, net)
  net_set_types = if net.is_a?(Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2)
...
def bench_train_no_hidden(ios_list, qty_loops, charter_high_is_red, charter_high_is_blue, height, width)
  ...
  # net_bp_no_bias = Ai4cr::NeuralNetwork::Backpropagation.new(structure: structure, disable_bias: true)
  # net_tanh_no_bias = Ai4cr::NeuralNetwork::Cmn::MiniNet::Tanh.new(height: height, width: width, disable_bias: true)
  # net_sigm_no_bias = Ai4cr::NeuralNetwork::Cmn::MiniNet::Sigmoid.new(height: height, width: width, disable_bias: true)
  # net_relu_no_bias = Ai4cr::NeuralNetwork::Cmn::MiniNet::Relu.new(height: height, width: width, disable_bias: true)
...
def bench_train_hidden1(ios_list, qty_loops, charter_high_is_red, charter_high_is_blue, height, hidden, width)
  ...
  arr << net0_tanh
  arr << net1_tanh
  cns_tanh_tanh = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr)
  ...
  arr << net0_sigm
  arr << net1_sigm
  cns_sigm_sigm = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr)
  ...
  arr << net0_relu
  arr << net1_relu
  cns_relu_relu = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr)
  ...
  arr << net0_relu_sigm
  arr << net1_relu_sigm
  cns_relu_sigm = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr)
...
def bench_train_hidden2(ios_list, qty_loops, charter_high_is_red, charter_high_is_blue, height, hidden1, hidden2, width)
  ...
  arr << net1_tanh
  arr << net2_tanh
  cns_tanh_tanh_tanh = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr)
  ...
  arr << net1_sigm
  arr << net2_sigm
  cns_sigm_sigm_sigm = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr)
  ...
  arr << net1_relu
  arr << net2_relu
  cns_relu_relu_relu = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr)
  ...
  arr << net1_relu
  arr << net2_Sigm
  cns_tanh_relu_sigm = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr)
  ...
  cns_234 = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.new(arr_234)
  File.write("tmp/cns_234.json", cns_234.to_pretty_json(indent: "  "))
  # cns_234b = Ai4cr::NeuralNetwork::Cmn::ConnectedNetSet::ChainV2.from_json(File.read("tmp/cns_234.json"))
