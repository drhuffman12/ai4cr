...
describe Ai4cr::NeuralNetwork::Cmn::MiniNetRelu do
  describe "#train" do
    describe "using image data (input) and shape flags (output) for triangle, square, and cross" do
      ...
      net = Ai4cr::NeuralNetwork::Cmn::MiniNetRelu.new(height: 256, width: 3, error_distance_history_max: 60)
      ...
      describe "and training #{qty} times each at a learning rate of #{net.learning_rate.round(6)}" do
        ...
        #     json = net.to_json
        #     net2 = Ai4cr::NeuralNetwork::Cmn::MiniNetRelu.from_json(json)
